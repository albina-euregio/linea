...
Visualizations of meteorological data, such as automated weather stations. The view is defined by the [EAWS](https://www.avalanches.org/) *work group communication*.
