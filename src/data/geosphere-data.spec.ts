...
test("parseGeosphereData", async () => {
  const metadata = MetadataSchema.parse({
    ...
    id_type: "Synop",
  } satisfies z.input<typeof MetadataSchema>);
  const collection = FeatureCollectionSchema.parse({
        ...
        properties: {
          parameters: {
            ...
            DD: {
              name: "Windrichtung",
              unit: "°",
              data: [194.0, 166.0, 329.0, 12.0, 149.0, 38.0, 50.0, 62.0, 138.0, 211.0, 221.0, 66.0],
            },
            P: {
              name: "Luftdruck",
              unit: "hPa",
              data: [
                859.5, 859.3, 859.2, 859.2, 859.1, 859.1, 859.0, 859.0, 858.8, 858.8, 858.8, 858.9,
              ],
            },
            RF: {
